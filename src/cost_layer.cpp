...
cost_layer make_cost_layer(int batch, int inputs, COST_TYPE cost_type, float scale)
{
    ...
    l.delta = static_cast<float*>(calloc(inputs*batch, sizeof(float)));
    l.output = static_cast<float*>(calloc(inputs*batch, sizeof(float)));
...
void resize_cost_layer(cost_layer *l, int inputs)
{
    l->inputs = inputs;
    l->outputs = inputs;
    l->delta = static_cast<float*>(realloc(l->delta, inputs*l->batch*sizeof(float)));
    l->output = static_cast<float*>(realloc(l->output, inputs*l->batch*sizeof(float)));
#ifdef GPU
