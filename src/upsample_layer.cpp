...
layer make_upsample_layer(int batch, int w, int h, int c, int stride)
{
    ...
    l.delta = static_cast<float*>(calloc(l.outputs*batch, sizeof(float)));
    l.output = static_cast<float*>(calloc(l.outputs*batch, sizeof(float)));;
...
void resize_upsample_layer(layer *l, int w, int h)
{
    ...
    l->delta = static_cast<float*>(realloc(l->delta, l->outputs*l->batch*sizeof(float)));
    l->output = static_cast<float*>(realloc(l->output, l->outputs*l->batch*sizeof(float)));
