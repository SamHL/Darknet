...
layer make_connected_layer(int batch, int inputs, int outputs, ACTIVATION activation, int batch_normalize, int adam)
{
    ...
    l.output = static_cast<float*>(calloc(batch*outputs, sizeof(float)));
    l.delta = static_cast<float*>(calloc(batch*outputs, sizeof(float)));

    l.weight_updates = static_cast<float*>(calloc(inputs*outputs, sizeof(float)));
    l.bias_updates = static_cast<float*>(calloc(outputs, sizeof(float)));

    l.weights = static_cast<float*>(calloc(outputs*inputs, sizeof(float)));
    l.biases = static_cast<float*>(calloc(outputs, sizeof(float)));
    ...
    if(adam){
        l.m = static_cast<float*>(calloc(l.inputs*l.outputs, sizeof(float)));
        l.v = static_cast<float*>(calloc(l.inputs*l.outputs, sizeof(float)));
        l.bias_m = static_cast<float*>(calloc(l.outputs, sizeof(float)));
        l.scale_m = static_cast<float*>(calloc(l.outputs, sizeof(float)));
        l.bias_v = static_cast<float*>(calloc(l.outputs, sizeof(float)));
        l.scale_v = static_cast<float*>(calloc(l.outputs, sizeof(float)));
    }
    if(batch_normalize){
        l.scales = static_cast<float*>(calloc(outputs, sizeof(float)));
        l.scale_updates = static_cast<float*>(calloc(outputs, sizeof(float)));
        for(i = 0; i < outputs; ++i){
            l.scales[i] = 1;
        }

        l.mean = static_cast<float*>(calloc(outputs, sizeof(float)));
        l.mean_delta = static_cast<float*>(calloc(outputs, sizeof(float)));
        l.variance = static_cast<float*>(calloc(outputs, sizeof(float)));
        l.variance_delta = static_cast<float*>(calloc(outputs, sizeof(float)));

        l.rolling_mean = static_cast<float*>(calloc(outputs, sizeof(float)));
        l.rolling_variance = static_cast<float*>(calloc(outputs, sizeof(float)));

        l.x = static_cast<float*>(calloc(batch*outputs, sizeof(float)));
        l.x_norm = static_cast<float*>(calloc(batch*outputs, sizeof(float)));
    }
